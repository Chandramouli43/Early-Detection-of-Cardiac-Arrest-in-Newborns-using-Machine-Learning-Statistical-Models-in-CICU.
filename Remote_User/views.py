...
def Predict_Cardiac_Arrest_Type(request):
    if request.method == "POST":
        ...
        x = data[["Age_In_Days","Sex","ChestPainType","RestingBP","RestingECG","MaxHR","ExerciseAngina","Oldpeak","ST_Slope","slp","caa","thall"]]
        y = data['Results']
        ...
        list=[Age_In_Days,Sex,ChestPainType,RestingBP,RestingECG,MaxHR,ExerciseAngina,Oldpeak,ST_Slope,slp,caa,thall]
        print(list)
        predict_text = classifier.predict([[Age_In_Days,Sex,ChestPainType,RestingBP,RestingECG,MaxHR,ExerciseAngina,Oldpeak,ST_Slope,slp,caa,thall]])
